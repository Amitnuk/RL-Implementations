...
def run_launcher(args,Agent:DoubleDQNAgent,lowest_evaluation_score:int) :
...
def main() :
    ...
    Agent = DoubleDQNAgent(env_name=ENVIRONMENTS[args.env],
    ...
    if args.launch == MODES[0] :
        ...
        CHECKPOINT_FILE = f"./results/doubledqn/{args.env}/{args.env}_best.pth"
